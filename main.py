...
genre_create = ["Western", "Action", "Dramma"]
actors_create = [
    ("George", "Klooney"),
    ("Kianu", "Reaves"),
    ("Scarlett", "Keegan"),
...
def main() -> QuerySet:
    [Genre.objects.create(name=genre) for genre in genre_create]
    [Actor.objects.create(first_name=first_name, last_name=last_name) for first_name, last_name in actors_create]
